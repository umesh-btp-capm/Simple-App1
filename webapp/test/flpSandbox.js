		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapbtpsimpleapp1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpsimpleapp1-display": {
								"semanticObject": "sapbtpsimpleapp1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.simpleapp1",
									"url": sap.ui.require.toUrl("sap/btp/simpleapp1")
								}
							}
						}
					}
